...
## Backend
The backend should manage persisting and reading data.
 - Elasticsearch as Database
 Databasemodel:

| ID    | url | Titel | Topics | Keywords | TAGS |
| :---: | :-- | :---- | :----- | :------- | :--- |
| Identifier | The URL of the article | Title of the article| Topics generated by the Topic Modeling algorithm | Most common words, specific to the article (without: this, it, and, etc.| TAG_IDs of TAGS applied by the user) |
